...
export const SelectAIAgent: React.FC<SelectAIAgentProps> = ({
  ...
  const [appType, setAppType] = useState<"tailwind css" | "HTML/CSS">("tailwind css");
  ...
  return (
    ...
    >
      ...
      <div className="relative z-40 w-full max-w-[95%] sm:max-w-200 ">
      <ShineBorder shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]}  className="rounded-[28px]"/>
        <LayoutGroup>
          <AnimatePresence>
            {isMenuOpen && (
              <motion.div
          ...
          >
            ...
            <div className="mt-6 flex w-full items-center justify-between sm:mt-8">
              <motion.button
                onClick={() =>
                  setAppType((t) =>
                    t === "tailwind css" ? "HTML/CSS" : "tailwind css"
                  )
                }
